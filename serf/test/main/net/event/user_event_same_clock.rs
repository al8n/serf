  ...
  ($rt:ident) => {
    paste::paste! {
      mod [< $rt:snake >] {
        ...
        use serf_core::tests::{event::user_event_same_clock, next_socket_addr_v4, next_socket_addr_v6};
        use smol_str::SmolStr;

        #[test]
        fn test_user_event_same_clock_v4() {
          let name = "user_event_same_clock_v4";
          let mut opts = NetTransportOptions::new(SmolStr::new(name));
          opts.add_bind_address(next_socket_addr_v4(0));

          [< $rt:snake _run >](user_event_same_clock::<
            NetTransport<
              SmolStr,
        ...
        #[test]
        fn test_user_event_same_clock_v6() {
          let name = "user_event_same_clock_v6";
          let mut opts = NetTransportOptions::new(SmolStr::new(name));
