  ...
  ($rt:ident) => {
    paste::paste! {
      mod [< $rt:snake >] {
        ...
        use serf_core::tests::{event::query_params_encode_filters, next_socket_addr_v4, next_socket_addr_v6};
        use smol_str::SmolStr;

        #[test]
        fn test_query_params_encode_filters_v4() {
          let name = "query_params_encode_filters_v4";
          let mut opts = NetTransportOptions::new(SmolStr::new(name));
          opts.add_bind_address(next_socket_addr_v4(0));

          [< $rt:snake _run >](query_params_encode_filters::<
            NetTransport<
              SmolStr,
        ...
        #[test]
        fn test_query_params_encode_filters_v6() {
          let name = "query_params_encode_filters_v6";
          let mut opts = NetTransportOptions::new(SmolStr::new(name));
