...
///
/// serf addresses are family-agnostic configuration, so this boundary helper
/// accepts both IPv4 and IPv6. smoltcp's `From<SocketAddr> for Endpoint` requires
/// both `proto-ipv4` and `proto-ipv6`, which this crate enables.
#[inline]
