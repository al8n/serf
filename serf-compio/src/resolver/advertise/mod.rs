...
///
/// The driver calls this immediately after [`super::Resolver::resolve`] returns
/// more than one result for the configured advertise address. An implementor can
/// express simple policies (prefer IPv4, prefer IPv6, take the first) or consult
/// external state.
