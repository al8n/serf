...
//!
//! This is the bare-metal twin of `serf-embassy`'s host-test
...
//! stacks on a single-threaded executor. It is the in-memory link the two serf
//! nodes converge over, standing in for an MII/RMII peripheral.
//!
