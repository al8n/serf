  ...
  ($rt:ident) => {
    paste::paste! {
      mod [< $rt:snake >] {
        ...
        use serf_core::tests::{event::serf_remove_failed_events_leave, next_socket_addr_v4, next_socket_addr_v6};
        use smol_str::SmolStr;

        #[test]
        fn test_serf_remove_failed_events_leave_v4() {
        ...
        #[test]
        fn test_serf_remove_failed_events_leave_v6() {
          let name = "serf_remove_failed_events_leave1_v6";
          let mut opts = NetTransportOptions::new(SmolStr::new(name));
          opts.add_bind_address(next_socket_addr_v6());

          let name = "serf_remove_failed_events_leave2_v6";
          let mut opts2 = NetTransportOptions::new(SmolStr::new(name));
